...
- (void)initTracker:(CustomGLView *)view
{
    ...
    initializeLicenseManager("118-636-344-457-307-251-165-904-593-465-109.vlc");
...
- (NSData*)displayTrackingResults:(UILabel *)fpsLabel Status:(UILabel *)statusLabel Info:(UILabel *)infoLabel
{
	...
	if (trackingStatus == TRACK_STAT_OK)
    {
        ...
        NSData *myData = [NSData dataWithBytes:&trackingData length:sizeof(trackingData)];
        
        NSLog(@"Size is %.2f KB", (float)myData.length/1024.0f);
        return myData;
