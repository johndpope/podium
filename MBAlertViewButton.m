...
- (void)drawRect:(CGRect)rect {
    ...
    [_title sizeWithFont:kButtonFont minFontSize:8.0 actualFontSize:&actualSize forWidth:self.bounds.size.width - 20 lineBreakMode:NSLineBreakByClipping];
    
    CGSize otherSize = [_title sizeWithFont:[UIFont boldSystemFontOfSize:actualSize]];
    otherSize = [_title sizeWithAttributes:@{NSFontAttributeName:kButtonFont}];
